...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.socketEngine = [[BIDSocketEngine alloc] init];
    self.socketEngine.currentViewController = self.viewController;
    self.globalString = [[NSString alloc] initWithFormat:@"GlobalString"];
